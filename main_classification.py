...
if __name__ == "__main__":
    ...
    for simulation_type in simulation_types:
        ...
        df_combined = df_fairai[["simulation_type", "Protected_Feature", "Protected_Class", "target_bias", "pred_bias", "count", "weighted_Fairness_target", "weighted_Fairness_pred", "global_bias_direction", "fairness_class_0", "fairness_class_1", "fairness_class_2"]]
